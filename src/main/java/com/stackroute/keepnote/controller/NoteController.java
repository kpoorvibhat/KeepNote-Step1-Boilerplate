...
public class NoteController {
	...
	public String handlerMethod(ModelMap modelMap) {
		modelMap.addAttribute("save", noteRepository.getAllNotes());
	...
	*/
	...
	public String saveNoteHandler(@RequestParam("noteId") Integer noteId, @RequestParam("noteTitle") String title,
		...
		noteRepository.addNote(noteObject);
		modelMap.addAttribute("save", noteRepository.getAllNotes());
		return "index";
	}
